/* Hadoop Map Reduce Program to Compute Semester-wise(i.e. Fall/Spring/Winter/Summer) % of seats utilized. */
...
// Mapper1 will list "building", "building_total" and output values for "enrollments" and maximum enrollments respectively"
  public static class Mapper1
    ...
    public void map(Object key, Text value, Context context
    	...
    	context.write(word,val1);
     	...
     	word.set(fields[1].split(" ")[0] + "_total");
...
public void reduce(Text key, Iterable<IntWritable> values,
	...
	if(value1>value2)
	 z = (double)(value2/(double)value1) * 100.0;
	else
	 z = (double)(value1/(double)value2) * 100.0;
	w = Math.round(z*100.0)/100.0;
	context.write(key,new DoubleWritable(w));
}
}
